...
- (BWStatusBarOverlayStatus)LoadingStatus
{
...
+ (BWStatusBarOverlayStatus)LoadingStatus
{
    return [[BWStatusBarOverlay shared] LoadingStatus];
}
...
- (void)initializeToDefaultState {
    ...
    LoadingStatus = BWStatusBarOverlayStatusSuccess;
    [self setStatusBarStyle:[UIApplication sharedApplication].statusBarStyle animated:NO];
    [self setStatusBarStyle:UIStatusBarStyleDefault animated:NO];
